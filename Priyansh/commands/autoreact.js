...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) {
    ...
    if(react.includes("sakit") || react.includes("Sakit") || react.includes("saket") || react.includes("Saket") || react.includes("peyn") || react.includes("Peyn") || react.includes("Pain") || react.includes("mamatay") || react.includes("Mamatay") || react.includes("ayaw ko na") || react.includes("Ayaw ko na") || react.includes("saktan") || react.includes("Saktan") || react.includes("Sasaktan") || react.includes("sasaktan") || react.includes("sad") || react.includes("Sad") || react.includes("malungkot") || react.includes("Malungkot") || react.includes(" 😥") || react.includes("😰") || react.includes("😨") || react.includes("😢") || react.includes(":(") || react.includes("😔") || react.includes("😞") || react.includes("depress") || react.includes("stress") || react.includes("Stress") || react.includes("Depress") || react.includes("depression") || react.includes("Depression") || react.includes("💔") || react.includes("🥺") || react.includes("😭")) {
      var sad = {
				body: "𝗕𝗮𝘀 𝗞𝗮𝗿 𝗣𝗮𝗴𝗮𝗹𝗲 𝗥𝗼𝗹𝗮 𝗪𝗼𝗴𝗲 𝗞𝘆𝗮 𝗗𝗲𝗸𝗵 𝗔𝗻𝘀𝗼👉😭😢"
			}
			api.sendMessage(sad, threadID, messageID);
    api.setMessageReaction("😢", event.messageID, (err) => {}, true)
          };
    if(react.includes("Aoa") || react.includes("Salam") || react.includes("salam") || react.includes("aslamoalaikum") || react.includes("Asslamualaikum") || react.includes("Aslam o alaikum") || react.includes("Asslam o alaikum") || react.includes("SLAM")) {
      var sad = {
				body: "🥀"
			}
			api.sendMessage(sad, threadID, messageID);
    ...
    if(react.includes("IB") || react.includes("INBOX") || react.includes("Inbox") || react.includes("inbox") || react.includes("Ib") || 
react.includes("IB") || 
react.includes("ib") || 
react.includes("inbx")) {
      var sad = {
				body: "Ib Main Asa kYa Rakha ha Jo Edr ni Ha 🙄😵"
			}
			api.sendMessage(sad, threadID, messageID);
    api.setMessageReaction("🧐", event.messageID, (err) => {}, true)
          };
    if(react.includes("evening") || react.includes("everyone") || 
react.includes("goodmorning ") || react.includes("Good night") || react.includes("afternoon") || react.includes("good afternoon") || react.includes("NIT") || react.includes("eat") || react.includes("Eat") || react.includes("night") || react.includes("nyt") || react.includes("Night") || react.includes("Nyt")) {
      var heart = {
				body: "𝗚𝗼𝗼𝗱 𝗡𝗶𝗴𝗛𝘁 𝗦𝗼 𝗝𝗮𝗼 𝗦𝗵𝗮𝗯𝗮𝘀𝗵🥱❤️"
			}
